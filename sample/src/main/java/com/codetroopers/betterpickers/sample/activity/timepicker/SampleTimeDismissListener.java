 ...
 */
public class SampleTimeDismissListener extends BaseSampleActivity implements TimePickerDialogFragment.TimePickerDialogHandler, OnDialogDismissListener {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TimePickerBuilder tpb = new TimePickerBuilder()
                        ...
                        .setOnDismissListener(SampleTimeDismissListener.this);
                tpb.show();
            }
        });
    }
