...
public class NumberPickerBuilder {
	...
	public void show() {
		...
		final NumberPickerDialogFragment fragment = NumberPickerDialogFragment.newInstance(mRef, styleResId, minNumber, maxNumber, plusMinusVisibility, decimalVisibility, labelText);
