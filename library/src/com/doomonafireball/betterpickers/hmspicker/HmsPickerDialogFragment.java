...
public class HmsPickerDialogFragment extends DialogFragment {
	...
	private static final String REF_KEY = "HmsPickerDialogFragment_RefKey";
		...
		mSet.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				if (activity instanceof HmsPickerDialogHandler) {
					final HmsPickerDialogHandler act = (HmsPickerDialogHandler) activity;
					act.onDialogHmsSet(mRef, mPicker.getHours(), mPicker.getMinutes(), mPicker.getSeconds());
				} else if (fragment instanceof HmsPickerDialogHandler) {
					final HmsPickerDialogHandler frag = (HmsPickerDialogHandler) fragment;
					frag.onDialogHmsSet(mRef, mPicker.getHours(), mPicker.getMinutes(), mPicker.getSeconds());
				} else {
