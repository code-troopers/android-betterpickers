 ...
 */
public class RadialTimeWithSecondsPickerDialogFragment extends DialogFragment implements RadialWithSecondPickerLayout.OnValueSelectedListener {
    ...
    private OnTimeWithSecondsSetListener mCallback;
    ...
    private RadialWithSecondPickerLayout mTimePicker;
    ...
    public interface OnTimeWithSecondsSetListener {
         ...
         */
        void onTimeSet(RadialTimeWithSecondsPickerDialogFragment dialog, int hourOfDay, int minute, int second);
    }
    ...
    public static RadialTimeWithSecondsPickerDialogFragment newInstance(OnTimeWithSecondsSetListener callback,
                                                                        int hourOfDay, int minute, int second, boolean is24HourMode) {
        RadialTimeWithSecondsPickerDialogFragment ret = new RadialTimeWithSecondsPickerDialogFragment();
        ret.initialize(callback, hourOfDay, minute, second, is24HourMode);
        return ret;
    }

    public void initialize(OnTimeWithSecondsSetListener callback,
                           int hourOfDay, int minute, int second, boolean is24HourMode) {
        mCallback = callback;
    ...
    public void setOnTimeWithSecondsSetListener(OnTimeWithSecondsSetListener callback) {
        mCallback = callback;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(KEY_HOUR_OF_DAY)
                ...
                && savedInstanceState.containsKey(KEY_SECOND)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.radial_time_with_second_picker_dialog, null);
        ...
        mTimePicker = (RadialWithSecondPickerLayout) view.findViewById(R.id.time_picker);
        mTimePicker.setOnValueSelectedListener(this);
        mTimePicker.setOnKeyListener(keyboardListener);
        mTimePicker.initialize(getActivity(), mHapticFeedbackController, mInitialHourOfDay, mInitialMinute, mInitialSecond, mIs24HourMode);
        ...
        mDoneButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCallback != null) {
                    mCallback.onTimeSet(RadialTimeWithSecondsPickerDialogFragment.this,
    ...
    private void finishKbMode(boolean updateDisplays) {
        mInKbMode = false;
        if (!mTypedTimes.isEmpty()) {
            int values[] = getEnteredTime(null); // TODO GGG
            mTimePicker.setTime(values[0], values[1], 0);
            if (!mIs24HourMode) {
    ...
    private void updateDisplay(boolean allowEmptyDisplay) {
        if (!allowEmptyDisplay && mTypedTimes.isEmpty()) {
            ...
            String secondStr = (values[1] == -1) ? mDoublePlaceholderText :
