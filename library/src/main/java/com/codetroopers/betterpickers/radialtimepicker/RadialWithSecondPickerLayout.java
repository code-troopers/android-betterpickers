...
public class RadialWithSecondPickerLayout extends FrameLayout implements OnTouchListener {

    private static final String TAG = "RadialWithSecondPickerLayout";
    ...
    private static final int HOUR_INDEX = RadialTimeWithSecondsPickerDialogFragment.HOUR_INDEX;
    private static final int MINUTE_INDEX = RadialTimeWithSecondsPickerDialogFragment.MINUTE_INDEX;
    private static final int SECOND_INDEX = RadialTimeWithSecondsPickerDialogFragment.SECOND_INDEX;
    private static final int AMPM_INDEX = RadialTimeWithSecondsPickerDialogFragment.AMPM_INDEX;
    private static final int ENABLE_PICKER_INDEX = RadialTimeWithSecondsPickerDialogFragment.ENABLE_PICKER_INDEX;
    private static final int AM = RadialTimeWithSecondsPickerDialogFragment.AM;
    private static final int PM = RadialTimeWithSecondsPickerDialogFragment.PM;
    ...
    public RadialWithSecondPickerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
